...
class ApplicantApplicationFormTests(TestCase):
    ...
    def test_update_existing_application(self):
        ...
        # Create a PDF file for testing (since form validates PDF only)
        pdf_content = b"%PDF-1.0\n1 0 obj<</Type/Catalog/Pages 2 0 R>>endobj"
        initial_cover_letter = SimpleUploadedFile("cover.pdf", pdf_content, content_type="application/pdf")
        ...
        # Create updated PDF file
        updated_cover_letter = SimpleUploadedFile("cover.pdf", b"%PDF-1.0\nUpdated content", content_type="application/pdf")
        
        # Include all required fields in form submission
        form_data = {
            'first_name': 'Test',
            'last_name': 'Applicant',
            ...
            'cover_letter': updated_cover_letter,
