...
class JobApplicationTests(TestCase):
    ...
    def test_mismatched_education_data_lengths(self):
        """Test handling of mismatched education data list lengths"""
        self.client.login(username='@testapplicant', password='testpass123')
        ...
        application_data = {
            ...
            'confirm_information': True,
            'skills': 'Python, Django, Testing',
            # Mismatched lengths in education data
            'school[]': ['MIT', 'Stanford'],
            'degree[]': ['BSc'],  # Only one degree
            'discipline[]': ['Computer Science', 'AI'],
            'start_date[]': ['2015-09-01', '2019-09-01'],
            'end_date[]': ['2019-05-31', '2021-05-31']
        }
        ...
        # Verify only complete education entries are saved
        self.assertEqual(len(application.education), 1)
        self.assertEqual(application.education[0]['school'], 'MIT')
        self.assertEqual(application.education[0]['degree'], 'BSc')

    def test_mismatched_work_experience_data_lengths(self):
        """Test handling of mismatched work experience data list lengths"""
        self.client.login(username='@testapplicant', password='testpass123')
        ...
        application_data = {
            ...
            'confirm_information': True,
            'skills': 'Python, Django, Testing',
            # Mismatched lengths in work experience data
            'work_job_title[]': ['Software Engineer', 'Developer'],
            'work_employer[]': ['Google'],  # Only one employer
            'work_start_date[]': ['2019-06-01', '2021-06-01'],
            'work_end_date[]': ['2021-05-31', '2023-05-31'],
            'job_description[]': ['Full-stack development', 'Team leadership']
        }
        ...
        # Verify only complete work experience entries are saved
        self.assertEqual(len(application.work_experience), 1)
        self.assertEqual(application.work_experience[0]['work_job_title'], 'Software Engineer')
        self.assertEqual(application.work_experience[0]['work_employer'], 'Google')
